  ...
  <LayoutGrid class={style.info}>
    <LayoutGrid.Inner>
      <LayoutGrid.Cell tabletCols="12" desktopCols="6" class={style.text}>
        ...
        <p>
          Google I/O Extended 2022 Cebu brings together experts in Machine Learning, Android, Web
          and Cloud technologies to a day full of sessions, workshops and showcases.
        </p>
        <p>
      ...
      <LayoutGrid.Cell tabletCols="12" desktopCols="5" class={style.stats}>
        ...
        <InfoStat value="5" label="Breakout Sessions" />
      </LayoutGrid.Cell>
    </LayoutGrid.Inner>
  </LayoutGrid>
);
