      ...
      <header>
        <TopAppBar class={style.topAppBar}>
          <TopAppBar.Row class={style.topAppBarRow}>
            <TopAppBar.Section align-start>
              <TopAppBar.Icon class={style.icon} onClick={this.openDrawer} navigation>
                menu
              </TopAppBar.Icon>
            </TopAppBar.Section>
            <TopAppBar.Section class={style.navigation} align-end>
              <Link class={style.link} activeClassName={style.linkActive} href="/">
                Home
              </Link>
              <Link class={style.link} activeClassName={style.linkActive} href="/speakers">
                Speakers
              </Link>
              <Link class={style.link} activeClassName={style.linkActive} href="/schedule">
                Schedule
              </Link>
            </TopAppBar.Section>
          </TopAppBar.Row>
        ...
        >
          ...
          <Drawer.DrawerContent>
            ...
            <Drawer.DrawerItem
              selected={currentRoute === '/speakers'}
              onClick={() => this.linkTo('/speakers')}
            >
              Speakers
            </Drawer.DrawerItem>
            <Drawer.DrawerItem
              selected={currentRoute === '/schedule'}
              onClick={() => this.linkTo('/schedule')}
            >
              Schedule
            </Drawer.DrawerItem>
          </Drawer.DrawerContent>
